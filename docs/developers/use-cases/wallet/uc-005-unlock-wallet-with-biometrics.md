...
- Biometric authentication has been enabled ([UC-004](/docs/developers/use-cases/wallet/uc-004-enable-biometric-authentication)) — `biometricEnabled: true` in the Tauri Store
